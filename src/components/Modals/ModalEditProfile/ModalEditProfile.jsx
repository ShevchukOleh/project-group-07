...
import { AddAvatar, IconPlus, IconPlusAvatar, ModalButton } from './ModalEditProfile.styled';
import { addUserAvatar, fetchCurrentUser } from 'store/AsyncThunk/asyncThunkUsersAuth';
              ...
              <AddAvatar>
                ...
                <label htmlFor="file-input">
                    <IconButton color="primary" component="span">
                        <img src={userAvatar} alt='user-avatar' style={{ width: 68, height: 68 }} />
                    <IconPlusAvatar>
                        <IconPlus/>
                    </IconPlusAvatar>
                  </IconButton>
